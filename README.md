...
for example, <br>
\- why is there a webring and a list of cobalt-related projects on an instance list? <br>
\- why do i need to download stuff i have never heard before to run it? <br>
\- how can i run it on windows (without using wsl) when there is only an .sh file to run it? <br>
\- why can't it just be a docker container? <br>
even with the guide on how to run it (that has been removed now), it was REALLY confusing for me.

also, **when i was first planning on making this, and i first set it up**, a single scan took 40 MINUTES and it has also decided to throw an error at me every time after scanning. now it has been fixed and it takes less than 10 minutes<sup><a href="https://discord.com/channels/1049706293700591677/1049740077460377660/1292575347488981225">[1]</a>

that doesn't mean i don't like the instance list or hyperdefined, i'm just saying why i made a second one
